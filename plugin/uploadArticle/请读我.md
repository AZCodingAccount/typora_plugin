...
由于CSDN是直接逆向的接口，上传文章大概是2s左右，两个selenium自动化登录的平台上传时间长一点，20s左右
...
<img src="https://my-picture-bed1-1321100201.cos.ap-beijing.myqcloud.com/mypictures/%25E7%25A6%2581%25E7%2594%25A8.gif" alt="禁用" width=50% />
...
graph TD
    ...
    B --> D[uploadToCSDNPlugin]
    B --> E[uploadToWordPressPlugin]
    B --> F[uploadToAllPlatformPlugin]
    C --> G[Plugin2UploadBridge]
    D --> G[Plugin2UploadBridge]
    E --> G[Plugin2UploadBridge]
    F --> G[Plugin2UploadBridge]
    G --> H[UploadController]
    H --> I[BaseUploaderInterface]
    I --> J[CnBlogUploader]
    I --> K[CsdnUploader]
    I --> L[WordpressUploader]
